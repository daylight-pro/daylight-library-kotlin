...
class ModIntFactory(private val mod: Int) {
    private val ma: ModArithmetic = ModArithmetic.of(mod)
    ...
    inner class ModInt(private var value: Int) {
        ...
        operator fun plus(mi: ModInt): ModInt {
            return ModInt(ma.add(value, mi.value))
        }

        operator fun plus(i: Int): ModInt {
            return this + create(i)
        }

        operator fun plus(i: Long): ModInt {
            return this + create(i)
        }

        operator fun minus(mi: ModInt): ModInt {
            return ModInt(ma.sub(value, mi.value))
        }

        operator fun minus(i: Int): ModInt {
            return this - create(i)
        }

        operator fun minus(i: Long): ModInt {
            return this - create(i)
        }

        operator fun times(mi: ModInt): ModInt {
            return ModInt(ma.mul(value, mi.value))
        }

        operator fun times(i: Int): ModInt {
            return this * create(i)
        }

        operator fun times(i: Long): ModInt {
            return this * create(i)
        }
        ...
        operator fun div(i: Int): ModInt {
            return this / create(i)
        }

        operator fun div(i: Long): ModInt {
            return this / create(i)
        }
        ...
        operator fun plusAssign(mi: ModInt) {
        ...
        operator fun plusAssign(i: Long) {
            this += create(i)
        }

        operator fun minusAssign(mi: ModInt) {
        ...
        operator fun minusAssign(i: Long) {
            this -= create(i)
        }

        operator fun timesAssign(mi: ModInt) {
        ...
        operator fun timesAssign(i: Long) {
            this *= create(i)
        }

        operator fun divAssign(mi: ModInt) {
